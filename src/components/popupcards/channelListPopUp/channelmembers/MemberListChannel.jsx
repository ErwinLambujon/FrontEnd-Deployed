...
const MembersListChannel = ({
    ...
    const fetchMembersEmails = async () => {
      try {
        ...
        const membersResponse = await axios.get(
          `https://babyjoy456.pythonanywhere.com/api/channels/${channelId}/members/`,
          {
            headers: {
        ...
        const membersData = await Promise.all(
          membersResponse.data.map(async (member) => {
            const userResponse = await axios.get(
              `https://babyjoy456.pythonanywhere.com/api/user/${member.member_id}/`,
              {
                headers: {
                  Authorization: `Token ${token}`,
                },
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `https://babyjoy456.pythonanywhere.com/api/channels/${channelId}/members/${memberToDelete.id}/`,
        {
          headers: {
            Authorization: `Token ${token}`,
          },
